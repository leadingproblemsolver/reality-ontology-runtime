...
## Current public proof: construction planning

If you came here from the construction-planning post, the implementation is currently under review in **[PR #13](https://github.com/leadingproblemsolver/reality-ontology-runtime/pull/13)** rather than merged into `main`.

Start with these five surfaces, in this order:

1. **[Public proof summary](https://github.com/leadingproblemsolver/reality-ontology-runtime/blob/7eda2f925adf558aa128ad8e656f7c7edf3c3571/docs/CONSTRUCTION_PUBLIC_PROOF.md)** — plain-language problem, exact receipt, limits, and next real-world test.
2. **[Expected change-impact output](https://github.com/leadingproblemsolver/reality-ontology-runtime/blob/7eda2f925adf558aa128ad8e656f7c7edf3c3571/examples/construction/expected/change_impact.csv)** — the actual source-linked CSV produced by the checked-in fixture.
3. **[Construction tests](https://github.com/leadingproblemsolver/reality-ontology-runtime/blob/7eda2f925adf558aa128ad8e656f7c7edf3c3571/tests/test_construction_planning.py)** — deterministic regression, failure cases, provenance checks, and byte-identical rerun check.
4. **[Construction implementation](https://github.com/leadingproblemsolver/reality-ontology-runtime/blob/7eda2f925adf558aa128ad8e656f7c7edf3c3571/src/reality_ontology/domains/construction_planning/core.py)** — parsing, readiness projection, schedule diff, provenance, and impact construction.
5. **[Full construction contract](https://github.com/leadingproblemsolver/reality-ontology-runtime/blob/7eda2f925adf558aa128ad8e656f7c7edf3c3571/docs/CONSTRUCTION_PLANNING_MVP.md)** — input contract, statuses, assumptions, hard failures, and known limitations.
...
If you only want to inspect the expected result without running anything, open the **[checked-in change-impact output](https://github.com/leadingproblemsolver/reality-ontology-runtime/blob/7eda2f925adf558aa128ad8e656f7c7edf3c3571/examples/construction/expected/change_impact.csv)**.
...
| Goal | Start here |
|---|---|
| Understand the construction proof quickly | [Public proof summary](https://github.com/leadingproblemsolver/reality-ontology-runtime/blob/7eda2f925adf558aa128ad8e656f7c7edf3c3571/docs/CONSTRUCTION_PUBLIC_PROOF.md) |
| Inspect actual construction output | [Expected change-impact CSV](https://github.com/leadingproblemsolver/reality-ontology-runtime/blob/7eda2f925adf558aa128ad8e656f7c7edf3c3571/examples/construction/expected/change_impact.csv) |
| Audit construction behavior/tests | [Construction tests](https://github.com/leadingproblemsolver/reality-ontology-runtime/blob/7eda2f925adf558aa128ad8e656f7c7edf3c3571/tests/test_construction_planning.py) |
| Inspect construction implementation | [Construction core](https://github.com/leadingproblemsolver/reality-ontology-runtime/blob/7eda2f925adf558aa128ad8e656f7c7edf3c3571/src/reality_ontology/domains/construction_planning/core.py) |
| Understand construction assumptions/limits | [Construction contract](https://github.com/leadingproblemsolver/reality-ontology-runtime/blob/7eda2f925adf558aa128ad8e656f7c7edf3c3571/docs/CONSTRUCTION_PLANNING_MVP.md) |
